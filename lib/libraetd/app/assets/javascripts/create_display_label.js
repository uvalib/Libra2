window.createDisplayLabel = function(file) {
	...
	var lastName = $("#generic_work_author_last_name").val().split(" ")[0];
	var firstName = $("#generic_work_author_first_name").val().split(" ")[0];
	...
	var filtered = nextIndex + "_" + lastName + "_" + firstName + "_" + year + "_" + degree;
	filtered = filtered.replace( /[^0-9a-zA-Z-_]/g, '' );
