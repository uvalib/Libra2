...
namespace :libraetd do
  ...
  task send_did_submit_author: :environment do |t, args|
    ...
    ThesisMailers.thesis_submitted_author( work, "#{work.author_first_name} #{work.author_last_name}", MAIL_SENDER ).deliver_later
  ...
  task send_did_submit_registrar: :environment do |t, args|
    ...
    ThesisMailers.thesis_submitted_registrar( work,
                                              "#{work.author_first_name} #{work.author_last_name}",
