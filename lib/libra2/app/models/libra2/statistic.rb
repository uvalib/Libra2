require_dependency 'libra2/app/services/libra2/analytics'
...
module Libra2
  class Statistic < ActiveRecord::Base
    ...
    class << self
      ...
      def pw_statistics(start_date, object)
        path = polymorphic_path(object)
        Libra2::Analytics.pageviews( { sort: 'date',
      ...
      private
        ...
        def combined_stats(object, start_date, object_method, ga_key, user_id = nil)
          ...
          if stat_cache_info[:ga_start_date] < Time.zone.today
            ga_stats = pw_statistics(stat_cache_info[:ga_start_date], object)
