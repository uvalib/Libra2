class PersonInput < MultiValueInput
  ...
  def build_field(value, index)
    ...
    department_options = content_tag(:div, nil, class: 'department-options')
    input1 = content_tag(:div, raw(input1 + department_options), { class: "department", "data-departments" => department })
